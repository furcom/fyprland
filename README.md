...
4. Some configs will be generated by wallust because of dynamic color palette generation.
...
5. Installed packages:
    - If you don't want to install a specific package (e.g. fusuma) go to the bottom of `install.sh` where it says "MAIN SCRIPT" and comment the package (e.g. #install_fusuma)
